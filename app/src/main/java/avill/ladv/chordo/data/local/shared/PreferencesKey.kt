...
import avill.ladv.chordo.data.local.LocalDataSource.Companion.PREFERENCE_FIRST_LAUNCH
import avill.ladv.chordo.data.local.LocalDataSource.Companion.PREFERENCE_NAME
...
class PreferencesKey @Inject constructor(@ApplicationContext private val context: Context) {
